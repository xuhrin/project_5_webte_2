...
return [
    ...
    'login_begin' => 'Stlačte na tlačidlo v hornom paneli (alebo otvorte hamburgerové menu - tri čiarky) s textom ":login".',
    ...
    'logout_begin' => 'Stlačte na tlačidlo v hornom paneli (alebo otvorte hamburgerové menu - tri čiarky) s vaším menom.',
    ...
    'language_begin' => 'Stlačte na tlačidlo v hornom paneli (alebo otvorte hamburgerové menu - tri čiarky) s textom ":language".',
    'language_submit' => 'Vyberte jazyk z padajúceho (alebo kolapsujúceho) menu.',
    'role_title' => 'Výberte role',
